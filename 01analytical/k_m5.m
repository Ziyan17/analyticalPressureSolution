...
%text(0.6e-8,-1.0e5, '$k = 1 \times 10^{-5}$ m/s','FontSize',16,'Interpreter','latex')
text(1.8e3, 0.6e-8, '$\alpha_R / \alpha_D = 2$','FontSize',16,'Interpreter','latex')
