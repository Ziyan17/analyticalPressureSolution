...
%text(0.6e-8,-0.22e6, '$k = 1 \times 10^{-6}$ m/s','FontSize',16,'Interpreter','latex')
text(2e3, 0.6e-8, '$\alpha_R / \alpha_D = 0.2$','FontSize',16,'Interpreter','latex')
